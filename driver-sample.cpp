...
void RotateTest()
{
  ...
  cout << "Point " << pt1 << " rotated " 
       << angle << " degrees is " << pt2 << endl;
...
void DistanceTest()
{
  ...
  cout.setf(std::ios_base::fixed, std::ios::floatfield);
  std::cout.precision(3);
  cout << "Distance between " << pt2 
       << " and " << pt1 << " is " << distance << endl;
 
  distance = pt1 - pt2;
  cout << "Distance between " << pt1 
       << " and " << pt2 << " is " << distance << endl;

  pt1 = Point(-5, 3);
  pt2 = Point(-1, -7);

  distance = pt2 - pt1;
  cout << "Distance between " << pt2 << " and "
       << pt1 << " is " << distance << endl;
...
void InputTest()
{
  ...
  cout << "Midpoint of " << pt1 << " and " 
       << pt2 << " is " << (pt1 ^ pt2) << endl;
  cout << "Distance between " << pt1 << " and " <<
   pt2 << " is " << (pt1 - pt2) << endl;
